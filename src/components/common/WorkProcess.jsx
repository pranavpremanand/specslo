  ...
  return (
    <div className="py-14 relative">
      <div className="wrapper space-y-6">
        ...
        <p className="desc text-center max-w-4xl mx-auto text-[#FEFEFE]" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="space-y-12 md:space-y-0">
            {workProcess.map((item, index) => (
              ...
              >
                ...
                {/* Content Box */}
                <div className={`w-full md:w-[45%] group hover:bg-gradient-to-b from-primary/30 to-primary/10 
