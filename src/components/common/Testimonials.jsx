    ...
    <div className="py-14 relative overflow-hidden">
      ...
      <div data-aos="fade-up" className="wrapper text-center space-y-3 mb-8">
        ...
        <p className="desc max-w-4xl mx-auto">
          ...
          our innovative, spec-driven solutions. See how Specslo delivers
        ...
        {testimonials.concat(testimonials, testimonials).map((item, index) => (
          <SwiperSlide key={index} className="text-white">
            <div className="flex flex-col justify-center items-center">
              <img
                src={item.image}
                className="z-[1] w-[6rem] h-[6rem] min-w-[6rem] object-cover rounded-full border-4 border-black"
                alt=""
                loading="lazy"
              />
              <div className="content space-y-2 md:min-h-[20rem] lg:min-h-[15rem] flex flex-col justify-between bg-black text-center -translate-y-[3rem] pt-[4rem] rounded-xl p-6">
